...
> This is a research prototype. The Android shell now validates APKs, resolves the launcher, invokes the Rust Dalvik/runtime pipeline, and reports unsupported calls; broad game compatibility is not claimed yet.
...
- A staged runtime object with launcher resolution, Activity lifecycle boot, resource registration, and a Dalvik 035 interpreter for the implemented opcode subset.
...
1. Expand Dalvik 035 opcode and invoke/direct/virtual dispatch coverage.
2. Expand the Java/Android framework shim: `Activity`, `View`, input, resources, lifecycle, and `Canvas`.
3. Connect the software framebuffer and GLES 1.x calls to the Android presentation surface.
4. Add audio, filesystem, timers, and a minimal package manager.
